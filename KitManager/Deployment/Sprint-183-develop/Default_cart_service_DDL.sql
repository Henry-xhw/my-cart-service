...
exec msdb.dbo.p_KitFileApplicationHistory_ins_Info 4589,17804,'cart.sql',0
GO
...
--/KitManagerFileID=17805
if exists(select top 1 1  from msdb.INFORMATION_SCHEMA.ROUTINES where routine_name='p_KitFileApplicationHistory_ins_Info')
exec msdb.dbo.p_KitFileApplicationHistory_ins_Info 4589,17805,'cart_item.sql',0
GO
...
--/KitManagerFileID=17876
if exists(select top 1 1  from msdb.INFORMATION_SCHEMA.ROUTINES where routine_name='p_KitFileApplicationHistory_ins_Info')
exec msdb.dbo.p_KitFileApplicationHistory_ins_Info 4589,17876,'cart_item_fee.sql',0
GO
...
--/KitManagerFileID=17877
if exists(select top 1 1  from msdb.INFORMATION_SCHEMA.ROUTINES where routine_name='p_KitFileApplicationHistory_ins_Info')
exec msdb.dbo.p_KitFileApplicationHistory_ins_Info 4589,17877,'cart_items_cart_item_fee.sql',0
GO
...
--/KitManagerFileID=17803
if exists(select top 1 1  from msdb.INFORMATION_SCHEMA.ROUTINES where routine_name='p_KitFileApplicationHistory_ins_Info')
exec msdb.dbo.p_KitFileApplicationHistory_ins_Info 4589,17803,'cart_item_fk.sql',0
GO
...
--/KitManagerFileID=17875
if exists(select top 1 1  from msdb.INFORMATION_SCHEMA.ROUTINES where routine_name='p_KitFileApplicationHistory_ins_Info')
exec msdb.dbo.p_KitFileApplicationHistory_ins_Info 4589,17875,'fk_cart_items_cart_item_fee.sql',0
GO
