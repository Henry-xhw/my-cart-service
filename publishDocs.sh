...
REMOTE_DOC_PATH='/opt/active/docs/fbi/cart-service'
...
#e.g. rsync -avz -e ssh build/asciidoc/html5/* jfang1@share-apidocs.activenetwork.com:/opt/active/docs/fbi/cart-service/0.0.1-SNAPSHOT
${uploadDocCmd}
