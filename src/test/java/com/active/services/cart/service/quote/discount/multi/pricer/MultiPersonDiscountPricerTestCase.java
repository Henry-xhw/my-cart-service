...
public class MultiPersonDiscountPricerTestCase {
    private MultiPersonDiscountPricer multiPersonDiscountPricer;
    ...
    public void setUp() {
        ...
        multiPersonDiscountPricer = new MultiPersonDiscountPricer(mdCartItem, multiDiscountThresholdSetting);
    ...
    public void shouldAdvanceTier() {
        ...
        prevItem.setPersonIdentifier("AA");
        CartItem nextItem = CartDataFactory.cartItem();
        nextItem.setPersonIdentifier("BB");
        Assert.assertTrue(multiPersonDiscountPricer.shouldAdvanceTier(prevItem, nextItem));
    }

    @Test
    public void countTiers() {
        Assert.assertEquals(4, multiPersonDiscountPricer.countTiers(effectiveSortedMdCartItems));
    }

    @Test
    public void getAllProductComparator() {
        Assert.assertNotNull(multiPersonDiscountPricer.getAllProductComparator());
    }
}
