...
public class CartRepository {
    ...
    public void updateCartReservationId(UUID cartId, UUID identifier) {
        cartMapper.updateCartReservationGroupId(cartId, identifier, ContextWrapper.get().getActorId());
    }
